...
<div id="appFastBuy" data-load="<?=SITE_TEMPLATE_PATH?>/images/picLoad.gif">
	<div id="appFastBuyContainer">
		<div class="heading">Купить <a href="#" class="close closeWindow"></a></div>
		<div class="container" id="fastBuyOpenContainer">
			...
			<div class="column">
				...
				<form action="<?=SITE_DIR?>callback/" id="fastBuyForm" method="GET">
					...
					<div class="formLine"><a href="#" id="fastBuyFormSubmit"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="Купить в один клик"> Купить</a></div>
				</form>
			</div>
		</div>
        ...
        <?if(!empty($arParams["USE_MASKED_INPUT"])):?>
			<script>
				$(function(){
					$("#fastBuyFormTelephone").mask("<?=$arParams["MASKED_INPUT_FORMAT"]?>");
				});
			</script>
		<?endif;?>
	</div>
