<?
	...
	if(!empty($arResult)){
		...
		$arResult["TABS"]["CATALOG_ELEMENT_DESCRIPTION_DOP"] = array(
			"DISABLED" => !empty($arResult["DETAIL_TEXT"]) ? "N" : "Y",
			"NAME" => "Дополнительно понадобятся",
			"ID" => "detailText_dop",
			"UNDER" => 1,
			"ANCHOR" => "dop"
		);
		$arResult["TABS"]["CATALOG_ELEMENT_DESCRIPTION_USTR"] = array(
			"DISABLED" => !empty($arResult["DETAIL_TEXT"]) ? "N" : "Y",
			"NAME" => "Устройство ДГУ",
			"ID" => "detailText_ustr",
			"UNDER" => 1,
		...
		$arResult["TABS"]["CATALOG_ELEMENT_DESCRIPTION_KOONTR"] = array(
			"DISABLED" => !empty($arResult["DETAIL_TEXT"]) ? "N" : "Y",
			"NAME" => "Контроллер",
			"ID" => "detailText_kontr",
			"UNDER" => 1,
		...
		$arResult["TABS"]["CATALOG_ELEMENT_DESCRIPTION_EX"] = array(
			"DISABLED" => !empty($arResult["DETAIL_TEXT"]) ? "N" : "Y",
			"NAME" => "Эксплуатация",
			"ID" => "detailText_ex",
			"UNDER" => 1,
		...
		$arResult["TABS"]["CATALOG_ELEMENT_DESCRIPTION_POD"] = array(
			"DISABLED" => !empty($arResult["DETAIL_TEXT"]) ? "N" : "Y",
			"NAME" => "Подключение и установка",
			"ID" => "detailText_pod",
			"UNDER" => 1,
			"ANCHOR" => "pod"
		);
		$arResult["TABS"]["CATALOG_ELEMENT_VARIANT"] = array(
			"DISABLED" => "N",
		...
		$arResult["TABS"]["CATALOG_ELEMENT_FILES"] = array(
			"DISABLED" => !empty($arResult["PROPERTIES"]["FILES"]["VALUE"]) ? "N" : "Y",
