...
<div class="mainTool">
	<div class="mainToolContainer">
		...
		<div class="mobileButtonsContainer columnRowWrap">
			<div class="addCartContainer">
				<?if(!empty($arResult["PRICE"])):?>
					<?if($arResult["CATALOG_AVAILABLE"] != "Y"):?>
						...
						<?else:?>
							<a href="#" class="addCart changeID changeQty changeCart disabled" data-id="<?=$arResult["ID"]?>" data-quantity="<?=$arResult["EXTRA_SETTINGS"]["BASKET_STEP"]?>"><span><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="<?=GetMessage("ADDCART_LABEL")?>" class="icon">В корзину</span></a>
						<?endif;?>
					<?else:?>
						<a href="#" class="addCart changeID changeQty changeCart" data-id="<?=$arResult["ID"]?>" data-quantity="<?=$arResult["EXTRA_SETTINGS"]["BASKET_STEP"]?>"><span><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="<?=GetMessage("ADDCART_LABEL")?>" class="icon">В корзину</span></a>
					<?endif;?>
				<?else:?>
			...
			<div class="preim">
				<div><div><img src="/upload/medialibrary/eef/7rknkykynndwqadswbw1ke5vg19d84we/1.png"></div><div>Наличие на складе</div></div>
				<div>
					<div>
						<img src="/upload/medialibrary/6ce/09m06v14cm7ody7fqcrcsdx7e1raeoej/2.png">
					</div>
				<div>
				Доставка по России и<br>Казахстану</div></div>
				<div><div><img src="/upload/medialibrary/0af/ejlhrtccki2b89ccsqwbx4qqr8syr1hn/3.png"></div><div>Безналичный расчет</div></div>
			</div>
			<div class="btn-wrap">
				...
				<div class="btn-simple saleright">Получить персональную<br>скидку у менеджера</div>
			</div>
