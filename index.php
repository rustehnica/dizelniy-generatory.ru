...
$APPLICATION->SetPageProperty("title", "Дизельные генераторы (ДГУ) купить " . $_SESSION["SOTBIT_REGIONS"]["UF_MORF"] . " - ООО Арктика");
$APPLICATION->SetPageProperty("description", "Продажа дизельных генераторов и электростанций от группы компаний «Арктика». Каталог оборудования. Ремонт и гарантийное обслуживание. ООО Арктика.");
$APPLICATION->SetPageProperty("keywords", "дизельные генераторы, дгу");
?>					
<?
	//include module
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PICTURE_WIDTH" => "220",
		"PICTURE_HEIGHT" => "200",
		"PROP_VALUE" => array(0 => "306",1 => "307",2 => "308",3 => "309",4 => "310",),
		"ELEMENTS_COUNT" => "10",
		"SORT_PROPERTY_NAME" => "SORT",
		"SORT_VALUE" => "ASC",
		"COMPONENT_TEMPLATE" => ".default"
